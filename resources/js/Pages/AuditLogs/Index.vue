            ...
            <div class="mx-auto max-w-7xl space-y-4 px-0 sm:px-6 lg:px-8">
                ...
                <div class="overflow-hidden rounded-2xl bg-[#f6fbf6] shadow ring-1 ring-[#cfe8d1]">
                    <div class="flex items-center justify-between border-b border-gray-200 px-6 py-4">
                        ...
                        <button
                            type="button"
                            class="inline-flex items-center space-x-2 rounded-lg border border-gray-300 px-3 py-2 text-sm text-gray-700 transition hover:bg-[#dff1e1]"
                        >
                    ...
                    <div class="overflow-x-auto">
                        <table class="min-w-full divide-y divide-gray-200">
                            ...
                            <tbody class="divide-y divide-gray-200 bg-[#f6fbf6]">
                                ...
                                <tr v-for="log in logs.data" :key="log.id" class="hover:bg-[#e8f5e9]">
